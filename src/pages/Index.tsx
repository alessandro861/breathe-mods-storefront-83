...
const Index: React.FC = () => {
      ...
      <SheetContent>
        <div className="pt-10 flex flex-col space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 mb-4">
            ...
            {currentUser && <Link to="/profile" className="w-full">
  ...
  return <Layout>
      ...
      <div className="container mx-auto flex flex-col items-center justify-center space-y-8 md:space-y-16 px-4 md:px-0">
        ...
        {!isMobile && <section className="w-full">
          ...
          duration: 0.8
            ...
            duration: 0.5
                ...
                <a href="https://discord.gg/Yr8aY3fW4f" target="_blank" rel="noopener noreferrer" className="w-full md:w-auto">
                  <Button size="lg" variant="outline" className="text-md w-full md:w-auto">
                    <Ticket className="mr-2 h-5 w-5" />
                    Join Discord
                  </Button>
                </a>
                {currentUser && <Link to="/purchases" className="w-full md:w-auto">
        ...
        {isMobile && <section className="w-full pb-4">
            <motion.div initial={{
          opacity: 0,
          y: 20
        }} animate={{
        ...
        {!isMobile && <section className="w-full mt-4 md:mt-0">
            <motion.div initial={{
          opacity: 0,
          y: 20
        }} animate={{
          ...
          }].map((feature, index) => <motion.div key={index} className="glass-panel rounded-xl p-5 text-center transition-all duration-300 hover:scale-105 hover:shadow-primary/20" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
        ...
        {isMobile && <section className="w-full pb-6">
            <motion.h3 initial={{
          opacity: 0
        }} animate={{
          opacity: 1
          ...
          duration: 0.7
            ...
            title: "Premium",
            desc: "Des mods de haute qualité"
          }, {
            icon: <Shield className="h-5 w-5 text-primary" />,
            title: "À jour",
            desc: "Compatibilité assurée"
          }, {
            icon: <Gift className="h-5 w-5 text-primary" />,
            title: "Sur mesure",
            desc: "Mods personnalisés"
          }, {
            icon: <LayoutGrid className="h-5 w-5 text-primary" />,
            title: "Polyvalent",
            desc: "De nombreuses options"
          }].map((feature, index) => <Card key={index} className="glass-panel overflow-hidden border-none">

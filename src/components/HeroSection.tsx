...
const HeroSection: React.FC = () => {
  ...
  return <div className="relative flex flex-col items-center justify-center py-6 md:py-16 text-center px-4 md:px-0 w-full">
      {/* Main Title */}
      <motion.h1 initial={{
      opacity: 0,
      y: -20
      ...
      duration: 0.7
          ...
          {[{
        title: "Haute Qualité",
        desc: "Modifications premium"
      }, {
        title: "Mis à jour",
        desc: "Dernières versions du jeu"
      }, {
        title: "Personnalisés",
        desc: "Mods sur mesure"
      }].map((feature, index) => <div key={index} className="glass-panel rounded-lg p-4 flex items-center justify-between">
              <div>
      ...
      duration: 0.7
          ...
          {[{
        title: "High Quality",
        desc: "Meticulously crafted modifications"
      }, {
        title: "Regularly Updated",
        desc: "Stay current with game updates"
      }, {
        title: "Custom Options",
        desc: "Request personalized mods"
      }].map((feature, index) => <div key={index} className="glass-panel rounded-lg p-5 transform transition-all duration-300 hover:scale-105 hover:shadow-primary/10">
